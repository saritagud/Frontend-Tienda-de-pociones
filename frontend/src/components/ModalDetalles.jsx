...
function ModalDetalles({isOpen, setIsOpen, potionId}){
    ...
    return(
        ...
        {isOpen && (
            ...
            <div className="bg-pocion2 bg-cover bg-no-repeat rounded-xl m-5 p-6 w-full text-azul flex flex-col justify-end items-end text-left text-xl font-Urbanist sm:w-[50%] sm:h-[60vh] md:text-2xl md:h-[80vh] xl:text-3xl lg:h-[60vh]">

                <div className='flex justify-start h-full mb-3'>
                    <FaWindowClose className=' text-2xl cursor-pointer md:text-3xl lg:text-5xl' onClick={()=>setIsOpen(false)}/>
                </div>
